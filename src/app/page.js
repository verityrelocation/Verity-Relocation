...
function Hero() {
  ...
  return (
    <section style={{ background: C.parchment, padding: "5rem 2.5rem 4rem", display: "flex", alignItems: "center", gap: "4rem", maxWidth: 1100, margin: "0 auto", opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(20px)", transition: "opacity 0.8s ease, transform 0.8s ease" }}>
      <div style={{ flex: 1.2 }}>
        ...
        <h1 style={{ fontFamily: "Georgia, serif", fontSize: 48, color: C.deep, lineHeight: 1.15, margin: 0, fontWeight: 400 }}>Your utilities.<br/>Handled.</h1>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <Link href="/get-started" style={{ background: C.deep, color: C.white, border: "none", borderRadius: 6, padding: "14px 32px", fontFamily: "'DM Sans', sans-serif", fontSize: 16, fontWeight: 500, textDecoration: "none" }}>Get started — $199 flat fee</Link>
          <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: C.muted }}>No hidden fees. All providers included.</span>
        </div>
      </div>
    ...
    <section style={{ background: C.parchment, padding: "5rem 2.5rem" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", textAlign: "center" }}>
        ...
        <div style={{ display: "inline-flex", alignItems: "baseline", gap: 8, marginTop: 8, marginBottom: 48 }}>
          <span style={{ fontFamily: "Georgia, serif", fontSize: 56, color: C.deep, lineHeight: 1 }}>$199</span>
...
function TrustBar() {
  return (
    <section style={{ background: C.deep, padding: "3.5rem 2.5rem" }}>
